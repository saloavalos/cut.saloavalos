...
var puntos = []; //arreglo de puntos para guardar las coordenadas de los puntos del poligono
...
function rotar(){   
  var a = parseInt(document.getElementById("angulo").value); //obtenemos el valor del ángulo de rotación

  var x = puntos[0].x;  //guardamos ubicación origial
  var y = puntos[0].y;
  ...
  var T= new Array (); 
      ...
      mover(x,y);  //trasladamos a posición inicial
}
